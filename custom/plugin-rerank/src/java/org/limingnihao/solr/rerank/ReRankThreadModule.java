 ...
 */
final public class ReRankThreadModule extends CloseHook implements NamedListInitializedPlugin  {

  public static ReRankThreadModule getInstance(NamedList args) {

    final ReRankThreadModule threadManager;
    ...
    if (threadManagerArgs.size() > 0) {
      ...
      threadManager = new ReRankThreadModule();
  ...
  public ReRankThreadModule() {
  }

  // For test use only.
  ReRankThreadModule(int totalPoolThreads, int numThreadsPerRequest) {
