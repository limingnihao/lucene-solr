...
import org.limingnihao.solr.queries.payloads.PayloadScoreBoostQuery;
 ...
 * @date 2020-03-20
 */
public class PayloadScoreBoostQParserPlugin extends QParserPlugin {
    public static final String NAME = "payload_score_boost";
    ...
    public QParser createParser(String qstr, SolrParams localParams, SolrParams params, SolrQueryRequest req) {
        return new QParser(qstr, localParams, params, req) {
            ...
            public Query parse() throws SyntaxError {
                ...
                String func = localParams.get("func", "sum");
                String calculate = localParams.get(PayloadScoreBoostUtil.CALCULATE, localParams.get(PayloadScoreBoostUtil.CALCULATE_ALIAS, PayloadScoreBoostUtil.CALCULATE_MUL));
                if (!(PayloadScoreBoostUtil.CALCULATE_MUL.equalsIgnoreCase(calculate) || PayloadScoreBoostUtil.CALCULATE_SUM.equalsIgnoreCase(calculate))) {
                    throw new SolrException(SolrException.ErrorCode.BAD_REQUEST, "Supported calculate are : mul , sum");
                }
                ...
                SpanQuery query;
                try {
                    query = PayloadScoreBoostUtil.createBoostSpanQuery(field, value, analyzer, operator);
                } catch (IOException e) {
                ...
                // 自定义query
                return new PayloadScoreBoostQuery(query, payloadFunction, payloadDecoder, includeSpanScore, calculate);
            }
        };
    }
}
